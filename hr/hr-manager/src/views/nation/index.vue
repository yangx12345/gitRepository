<template>
  <div class="container">
    ...
    <div>
      <el-dialog :title="addOrupdate === 'add' ? '增加民族':'修改民族'" :visible.sync="dialogFormVisible" @close="cancale">
        <el-form ref="addForm" :model="entity" :rules="rules">
          <el-form-item label="民族名称" :label-width="formLabelWidth" prop="name">
...
<script>
import { getListByCondition, batchDelete, add, update, deleteById } from '@/api/nation'
export default {
