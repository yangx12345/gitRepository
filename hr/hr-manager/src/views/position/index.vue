<template>
  <div class="container">
    ...
    <div>
      <el-dialog :title="addOrupdate === 'add' ? '增加职位':'修改职位'" :visible.sync="dialogFormVisible" @close="cancale">
...
<script>
import { getListByCondition, batchDelete, add, update, deleteById } from '@/api/position'
export default {
