  ...
  <div class="app-container">
    <el-form ref="form" :model="form" :inline="true" label-width="120px" :rules="userRules">
      ...
      <el-form-item label="所属部门" prop="departmentId">
        <treeselect v-model="form.departmentId" disabled :options="deptoptions" placeholder="" style="width:240px" />
      </el-form-item>

      <el-form-item label="职称">
        <el-select v-model="form.jobLevelId" disabled placeholder="请选择">
          <el-option
      ...
      <el-form-item label="职位">
        <el-select v-model="form.posId" disabled placeholder="请选择">
          <el-option
      ...
      <el-form-item label="聘用形式">
        <el-input v-model="form.engageForm" disabled placeholder="请输入" />
      </el-form-item>
      ...
      <el-form-item label="在职状态">
        <el-radio-group v-model="form.workState" disabled placeholder="请输入">
          <el-radio label="在职" value="在职" />
          <el-radio label="离职" value="离职" />
        </el-radio-group>
      </el-form-item>
      <el-form-item label="工号" prop="workID">
        <el-input v-model="form.workID" disabled placeholder="请输入" type="number" />
      </el-form-item>
      <el-form-item label="合同期限">
        <el-input v-model="form.contractTerm" disabled placeholder="请输入" type="number" />
      </el-form-item>
      ...
      <el-form-item label="工龄" label-width="100px">
        <el-input v-model="form.workAge" disabled placeholder="请输入" type="number" />
      </el-form-item>
      <br>
...
<script>
import { getById, update } from '@/api/employee.js'
...
export default {
  ...
  mounted() {
    ...
    getById(this.$store.getters.id).then(resp => {
      if (resp.code === 1) {
        this.form = resp.data
